...
I learnt about the different rules from babel compiler to decide if passing a function or string to React.createElement

I have found, that PropTypes are great in theory, but in practice, those console warnings are ignored by developers because they either did not notice them, or were in a hurry to ship code. Eventually they are just noise in the console that everyone ignores.
